...
module.exports = function(host, user, password) {
  ...
  return {
    ...
    // Issue CRUD opeerations
    create_issue: function(json, callback) {
      this.post('/rest/api/latest/issue', json, callback);
    },
    ...
    update_issue: function(id, json, callback) {
      this.put('/rest/api/latest/issue/' + id, json, callback);
    },
    delete_issue: function(id, callback) {
      this.del('/rest/api/latest/issue/' + id, callback);
    }
